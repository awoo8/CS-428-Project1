...
public class HawaiiWeatherAPIScript : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "https://api.openweathermap.org/data/2.5/weather?q=honolulu&APPID=fd09c77bcce316580081a48b3763ab68&units=imperial";
